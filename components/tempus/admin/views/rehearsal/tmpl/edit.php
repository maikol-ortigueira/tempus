	...
	<?php echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
		...
		<?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'convocation', Text::_('COM_TEMPUS_TAB_CONVOCATION', true)); ?>
			<div class="row-fluid">
				...
				<div class="span6">
					<?php echo $this->form->getInput('all_singers_button'); ?>
				</div>
			</div>
		<?php echo HTMLHelper::_('bootstrap.endTab'); ?>
...
function selectAllSingers() {
	var voices = ['soprano','alto','tenor','bass'];
	voices.forEach(function(e) {
		jQuery('#jform_convocation_' + e + '_ids option').prop('selected', true).trigger('liszt:updated');
	})
}
