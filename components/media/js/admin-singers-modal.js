...
(function() {
	 ...
	 * View element calls jSelectSinger when an article is clicked
	 * jSelectSinger creates the link tag, sends it to the editor,
	 * and closes the select frame.
	 **/
	window.jSelectSinger = function (id, title, catid, object, link, lang) {
		var hreflang = '', editor, tag;

		if (!Joomla.getOptions('xtd-singers')) {
			// Something went wrong!
			window.parent.jModalClose();
			return false;
		}

		editor = Joomla.getOptions('xtd-singers').editor;
