 ...
 * @since  1.6
 */
class TempusTableConcert extends Table
{
	/**
	 * Constructor
	 *
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'TempusTableconcert', array('typeAlias' => 'com_tempus.concert'));
		parent::__construct('#__tempus_concerts', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_tempus.concert.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_tempus/access.xml',
				"/access/section[@name='concert']/"
			);
			$default_actions = Access::getAssetRules('com_tempus.concert.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_tempus.concert.' . (int) $this->$k;
	}
